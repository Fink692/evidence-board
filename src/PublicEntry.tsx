...
export function PublicEntry() {
  ...
  return <main className="public-home">
    ...
    <footer className="public-footer"><span>Evidence Board · Built for The WebMCP Challenge</span><nav aria-label="Project resources"><a href="/walkthrough.html">Watch the 2:40 walkthrough<ArrowUpRight size={13} /></a><a href="https://github.com/Fink692/evidence-board" target="_blank" rel="noopener noreferrer">MIT source code<ArrowUpRight size={13} /></a></nav><span>Native tools. Human approval. No built-in model.</span></footer>
  </main>;
}
